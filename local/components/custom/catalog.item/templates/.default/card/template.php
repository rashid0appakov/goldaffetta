...
<?
    if ($arParams['SHOW_DISCOUNT_PERCENT'] === 'Y')
    {
      ...
      <div class="catalog__item-labels">
        <div class="catalog__item-labels-item catalog__item-labels-sale" id="<?=$itemIds['DSC_PERC']?>"
          <?=($price['PERCENT'] > 0 ? '' : 'style="display: none;"')?>>
          <div class="catalog__item-labels-tx"><?=-$price['PERCENT']?>%</div>
        </div>
      </div>
      <?
    }
?>
  ...
  <a class="catalog__item-img" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>" data-entity="image-wrapper">
    <img src="assets/images/catalog-img3.png" alt="">
  </a>
            ...
            if (!$haveOffers)
            {
              if ($actualItem['CAN_BUY'])
              {
                ...
                <div class="catalog__item-bottom" id="<?=$itemIds['BASKET_ACTIONS']?>">
                  <a class="catalog__item-btn" id="<?=$itemIds['BUY_LINK']?>" href="javascript:void(0)" rel="nofollow">
