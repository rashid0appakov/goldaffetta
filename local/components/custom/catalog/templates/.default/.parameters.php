...
CBitrixComponent::includeComponentClass('custom:catalog.section');
CBitrixComponent::includeComponentClass('custom:catalog.top');
CBitrixComponent::includeComponentClass('custom:catalog.element');
...
if ($iblockExists)
{
  ...
  $arTemplateParameters['LIST_PRODUCT_BLOCKS_ORDER'] = array(
    ...
    'TYPE' => 'CUSTOM',
    'JS_FILE' => CatalogSectionComponent::getSettingsScript('/local/components/custom/catalog.section', 'dragdrop_order'),
  ...
  $arTemplateParameters['LIST_PRODUCT_ROW_VARIANTS'] = array(
    ...
    'JS_FILE' => CatalogSectionComponent::getSettingsScript('/local/components/custom/catalog.section', 'dragdrop_add'),
  ...
  if (!empty($arCurrentValues['LABEL_PROP']))
  {
    ...
    $arTemplateParameters['LABEL_PROP_POSITION'] = array(
      ...
      'TYPE' => 'CUSTOM',
      'JS_FILE' => CatalogSectionComponent::getSettingsScript('/local/components/custom/catalog.section', 'position'),
